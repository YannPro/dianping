...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/js/common/validation/jquery.validate.js"></script>
		<script type="text/javascript" src="/js/common/validation/messages_zh.js"></script>
		<script type="text/javascript" src="/js/common/common.js"></script>
		<script type="text/javascript" src="/js/content/businessModify.js"></script>
	</head>
	<body style="background: #e1e9eb;">
		<form id="mainForm" method="post" action="/businesses/${modifyObj.id}" enctype="multipart/form-data">
			...
			<div class="right">
				...
				<div class="rightCont">
					...
					<div style="text-align: center; margin-top: 30px;">
						...
						<input class="tabSub" value="返     回" type="button" onclick="history.back(-1)"/>
					</div>
				</div>
			</div>
		</form>
