...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="/css/rmenu.css" type="text/css" rel="stylesheet" />
        <script src="/js/common/jquery-1.8.3.js" type="text/javascript"></script>
        <script src="/js/common/jquery.ztree.all.js" type="text/javascript"></script>
        <script src="/js/common/validation/jquery.validate.js" type="text/javascript"></script>
		<script src="/js/common/validation/messages_zh.js" type="text/javascript"></script>
        <script src="/js/common/common.js" type="text/javascript"></script>
        <script src="/js/system/auth.js" type="text/javascript"></script>
        <style type="text/css">
